...
var school_dal = require('../../../Desktop/resumeweblab/model/school_dal');
var address_dal = require('../../../Desktop/resumeweblab/model/address_dal');
...
// Return the add school form
router.get('/add', function(req, res) {
    // passing all the query parameters (req.query) to the insert function instead
...
router.get('/insert', function(req,res) {
    ...
    if(req.query.school_name == null) {
        ...
        // passing all the query parameters (req.query) to the insert of each individually
        school_dal.insert(req.query, function(err,result) {
            if (err) {
                ...
                //poor practice for redirecting the user to a different page, but
